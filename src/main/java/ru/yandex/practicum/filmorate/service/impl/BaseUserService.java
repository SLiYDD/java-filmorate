...
public class BaseUserService implements UserService {
    ...
    public List<User> getAllUser() {
        var listUser = storage.findAllUsers();
        if (listUser.isEmpty()) {
    ...
    public void addFriend(int userId, int friendId) {
        ...
        var friend = storage.findUserById(friendId)
    ...
    public List<User> findAllFriends(int id) {
        var user = storage.findUserById(id)
                .orElseThrow(() -> new NotFoundException("Пользователь с id : " + id + " не найден"));
    ...
    public List<User> findCommonFriends(int id, int otherId) {
        ...
        var friend = storage.findUserById(otherId)
                .orElseThrow(() -> new NotFoundException("Друг с id : " + otherId + " не найден"));

        var allFriends = concat(user.getFriends(), friend.getFriends());
    ...
    static List<Integer> concat(Set<Integer> friends, Set<Integer> otherFriend) {
